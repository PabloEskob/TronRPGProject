...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon")
	FGameplayTag WeaponTypeTag; // Например, "Weapon.Sword", "Weapon.Axe", "Weapon.Bow", "Weapon.Spear"
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Animation")
	TSoftObjectPtr<UBlendSpace> RunForwardBlendSpace;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Animation")
	TSoftObjectPtr<UBlendSpace> WalkBackwardBlendSpace;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Animation")
	TSoftObjectPtr<UBlendSpace> RunBackwardBlendSpace;
};
