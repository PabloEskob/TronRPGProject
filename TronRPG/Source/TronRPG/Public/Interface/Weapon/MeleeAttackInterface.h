...
public:
    ...
    /** Получить компонент комбо */
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Melee")
    UTronRpgComboComponent* GetComboComponent() const;
    virtual UTronRpgComboComponent* GetComboComponent_Implementation() const = 0;
    
    /** Получить компонент анимации */
    UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Melee")
    UAnimationComponent* GetAnimationComponent() const;
    virtual UAnimationComponent* GetAnimationComponent_Implementation() const = 0;
};
