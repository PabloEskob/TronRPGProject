...
#include "AuroraDevs_UGCEditor/Public/UGC_EditorNodes.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UUGC_PlayCameraAnimation);
UClass* Z_Construct_UClass_UUGC_PlayCameraAnimation_NoRegister()
{
	return UUGC_PlayCameraAnimation::StaticClass();
}
...
template<> AURORADEVS_UGCEDITOR_API UClass* StaticClass<UUGC_PlayCameraAnimation>()
{
	return UUGC_PlayCameraAnimation::StaticClass();
}
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UUGC_PlayCameraAnimationWithModifier);
UClass* Z_Construct_UClass_UUGC_PlayCameraAnimationWithModifier_NoRegister()
{
	return UUGC_PlayCameraAnimationWithModifier::StaticClass();
}
...
template<> AURORADEVS_UGCEDITOR_API UClass* StaticClass<UUGC_PlayCameraAnimationWithModifier>()
{
	return UUGC_PlayCameraAnimationWithModifier::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UnrealProject_RPG_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGCEditor_Public_UGC_EditorNodes_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUGC_PlayCameraAnimation, UUGC_PlayCameraAnimation::StaticClass, TEXT("UUGC_PlayCameraAnimation"), &Z_Registration_Info_UClass_UUGC_PlayCameraAnimation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_PlayCameraAnimation), 470638652U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProject_RPG_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGCEditor_Public_UGC_EditorNodes_h_2201766653(TEXT("/Script/AuroraDevs_UGCEditor"),
	Z_CompiledInDeferFile_FID_UnrealProject_RPG_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGCEditor_Public_UGC_EditorNodes_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProject_RPG_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGCEditor_Public_UGC_EditorNodes_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
