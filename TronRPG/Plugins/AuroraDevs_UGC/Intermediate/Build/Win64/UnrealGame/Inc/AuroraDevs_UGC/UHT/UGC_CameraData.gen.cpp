...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCameraYawFollowSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraYawFollowSettings_Statics::NewStructOps, TEXT("CameraYawFollowSettings"), &Z_Registration_Info_UScriptStruct_CameraYawFollowSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraYawFollowSettings), 2238464394U) },
		{ FCameraPitchFollowSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraPitchFollowSettings_Statics::NewStructOps, TEXT("CameraPitchFollowSettings"), &Z_Registration_Info_UScriptStruct_CameraPitchFollowSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraPitchFollowSettings), 3697689714U) },
		{ FCameraArmOffsetSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraArmOffsetSettings_Statics::NewStructOps, TEXT("CameraArmOffsetSettings"), &Z_Registration_Info_UScriptStruct_CameraArmOffsetSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraArmOffsetSettings), 85304216U) },
		{ FCameraPitchToArmAndFOVCurveSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraPitchToArmAndFOVCurveSettings_Statics::NewStructOps, TEXT("CameraPitchToArmAndFOVCurveSettings"), &Z_Registration_Info_UScriptStruct_CameraPitchToArmAndFOVCurveSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraPitchToArmAndFOVCurveSettings), 3773504738U) },
		{ FCameraArmLengthSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraArmLengthSettings_Statics::NewStructOps, TEXT("CameraArmLengthSettings"), &Z_Registration_Info_UScriptStruct_CameraArmLengthSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraArmLengthSettings), 3225540362U) },
		{ FCameraFOVSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraFOVSettings_Statics::NewStructOps, TEXT("CameraFOVSettings"), &Z_Registration_Info_UScriptStruct_CameraFOVSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraFOVSettings), 1294606668U) },
		{ FCameraYawConstraintSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraYawConstraintSettings_Statics::NewStructOps, TEXT("CameraYawConstraintSettings"), &Z_Registration_Info_UScriptStruct_CameraYawConstraintSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraYawConstraintSettings), 312075305U) },
		{ FCameraPitchConstraintSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraPitchConstraintSettings_Statics::NewStructOps, TEXT("CameraPitchConstraintSettings"), &Z_Registration_Info_UScriptStruct_CameraPitchConstraintSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraPitchConstraintSettings), 2662636389U) },
		{ FUGCCameraFocusSettings::StaticStruct, Z_Construct_UScriptStruct_FUGCCameraFocusSettings_Statics::NewStructOps, TEXT("UGCCameraFocusSettings"), &Z_Registration_Info_UScriptStruct_UGCCameraFocusSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUGCCameraFocusSettings), 3034352079U) },
		{ FUGCCameraSettingsWithGetActorsMethod::StaticStruct, Z_Construct_UScriptStruct_FUGCCameraSettingsWithGetActorsMethod_Statics::NewStructOps, TEXT("UGCCameraSettingsWithGetActorsMethod"), &Z_Registration_Info_UScriptStruct_UGCCameraSettingsWithGetActorsMethod, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUGCCameraSettingsWithGetActorsMethod), 2435064782U) },
		{ FCameraDitheringSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraDitheringSettings_Statics::NewStructOps, TEXT("CameraDitheringSettings"), &Z_Registration_Info_UScriptStruct_CameraDitheringSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraDitheringSettings), 2311802087U) },
		{ FPenetrationAvoidanceFeeler::StaticStruct, Z_Construct_UScriptStruct_FPenetrationAvoidanceFeeler_Statics::NewStructOps, TEXT("PenetrationAvoidanceFeeler"), &Z_Registration_Info_UScriptStruct_PenetrationAvoidanceFeeler, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPenetrationAvoidanceFeeler), 3001800156U) },
		{ FCameraCollisionSettings::StaticStruct, Z_Construct_UScriptStruct_FCameraCollisionSettings_Statics::NewStructOps, TEXT("CameraCollisionSettings"), &Z_Registration_Info_UScriptStruct_CameraCollisionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCameraCollisionSettings), 2574864636U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUGC_CameraAddOnModifierSettings, UUGC_CameraAddOnModifierSettings::StaticClass, TEXT("UUGC_CameraAddOnModifierSettings"), &Z_Registration_Info_UClass_UUGC_CameraAddOnModifierSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_CameraAddOnModifierSettings), 1545099126U) },
		{ Z_Construct_UClass_UUGC_CameraDataAssetBase, UUGC_CameraDataAssetBase::StaticClass, TEXT("UUGC_CameraDataAssetBase"), &Z_Registration_Info_UClass_UUGC_CameraDataAssetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_CameraDataAssetBase), 4040028609U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_4009598982(TEXT("/Script/AuroraDevs_UGC"),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Data_UGC_CameraData_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
