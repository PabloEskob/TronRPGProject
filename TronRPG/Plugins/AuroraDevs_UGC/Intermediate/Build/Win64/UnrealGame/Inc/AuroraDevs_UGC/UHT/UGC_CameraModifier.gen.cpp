...
{
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_OnAnyLevelSequenceEnded),NULL);
}
...
{
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_OnAnyLevelSequenceStarted),NULL);
}
...
void UUGC_CameraModifier::OnModifierDisabled(FMinimalViewInfo const& LastPOV, bool bWasImmediate)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_OnModifierDisabled),&Parms);
}
...
void UUGC_CameraModifier::OnModifierEnabled(FMinimalViewInfo const& LastPOV)
{
	...
	Parms.LastPOV=LastPOV;
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_OnModifierEnabled),&Parms);
}
...
void UUGC_CameraModifier::OnSetViewTarget(bool bImmediate, bool bNewTargetIsOwner)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_OnSetViewTarget),&Parms);
}
...
void UUGC_CameraModifier::ProcessBoomLengthAndFOV(float DeltaTime, float InFOV, float InArmLength, FVector ViewLocation, FRotator ViewRotation, float& OutFOV, float& OutArmLength)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_ProcessBoomLengthAndFOV),&Parms);
	OutFOV=Parms.OutFOV;
...
void UUGC_CameraModifier::ProcessBoomOffsets(float DeltaTime, FVector InSocketOffset, FVector InTargetOffset, FVector ViewLocation, FRotator ViewRotation, FVector& OutSocketOffset, FVector& OutTargetOffset)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_ProcessBoomOffsets),&Parms);
...
bool UUGC_CameraModifier::ProcessControlRotation(AActor* ViewTarget, float DeltaTime, FVector InViewLocation, FRotator InViewRotation, FRotator InLocalControlRotation, FRotator InDeltaRot, FRotator& OutDeltaRot)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_ProcessControlRotation),&Parms);
...
bool UUGC_CameraModifier::ProcessTurnRate(float DeltaTime, FRotator InLocalControlRotation, float InPitchTurnRate, float InYawTurnRate, float& OutPitchTurnRate, float& OutYawTurnRate)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraModifier_ProcessTurnRate),&Parms);
...
struct Z_Construct_UClass_UUGC_CameraModifier_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UUGC_CameraModifier_ComputeOwnerLookAndMovementDot, "ComputeOwnerLookAndMovementDot" }, // 3016783224
		...
		{ &Z_Construct_UFunction_UUGC_CameraModifier_OnModifierDisabled, "OnModifierDisabled" }, // 532816600
		{ &Z_Construct_UFunction_UUGC_CameraModifier_OnModifierEnabled, "OnModifierEnabled" }, // 2355929289
		{ &Z_Construct_UFunction_UUGC_CameraModifier_OnSetViewTarget, "OnSetViewTarget" }, // 3781741122
		{ &Z_Construct_UFunction_UUGC_CameraModifier_ProcessBoomLengthAndFOV, "ProcessBoomLengthAndFOV" }, // 2966957842
		{ &Z_Construct_UFunction_UUGC_CameraModifier_ProcessBoomOffsets, "ProcessBoomOffsets" }, // 931984443
		{ &Z_Construct_UFunction_UUGC_CameraModifier_ProcessControlRotation, "ProcessControlRotation" }, // 3114885250
		{ &Z_Construct_UFunction_UUGC_CameraModifier_ProcessTurnRate, "ProcessTurnRate" }, // 2620929981
...
void UUGC_CameraAddOnModifier::SetSettings(UUGC_CameraAddOnModifierSettings* InSettings)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_CameraAddOnModifier_SetSettings),&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_CameraModifier_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUGC_CameraModifier, UUGC_CameraModifier::StaticClass, TEXT("UUGC_CameraModifier"), &Z_Registration_Info_UClass_UUGC_CameraModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_CameraModifier), 198760356U) },
		{ Z_Construct_UClass_UUGC_CameraAddOnModifier, UUGC_CameraAddOnModifier::StaticClass, TEXT("UUGC_CameraAddOnModifier"), &Z_Registration_Info_UClass_UUGC_CameraAddOnModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_CameraAddOnModifier), 364320455U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_CameraModifier_h_2226176373(TEXT("/Script/AuroraDevs_UGC"),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_CameraModifier_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_CameraModifier_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
