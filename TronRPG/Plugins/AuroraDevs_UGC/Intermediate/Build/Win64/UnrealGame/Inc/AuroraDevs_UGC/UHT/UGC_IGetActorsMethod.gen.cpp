...
#include "AuroraDevs_UGC/Public/Camera/Methods/UGC_IGetActorsMethod.h"
...
void UUGC_IGetActorsMethod::GetActors(AActor* InOwner, FVector OwnerLocation, FVector ViewPointLocation, FRotator ViewPointRotation, TArray<AActor*>& OutActors)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UUGC_IGetActorsMethod_GetActors),&Parms);
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UUGC_IGetActorsMethod);
UClass* Z_Construct_UClass_UUGC_IGetActorsMethod_NoRegister()
{
	return UUGC_IGetActorsMethod::StaticClass();
}
struct Z_Construct_UClass_UUGC_IGetActorsMethod_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUGC_IGetActorsMethod_GetActors, "GetActors" }, // 396757931
	};
...
template<> AURORADEVS_UGC_API UClass* StaticClass<UUGC_IGetActorsMethod>()
{
	return UUGC_IGetActorsMethod::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Methods_UGC_IGetActorsMethod_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUGC_IGetActorsMethod, UUGC_IGetActorsMethod::StaticClass, TEXT("UUGC_IGetActorsMethod"), &Z_Registration_Info_UClass_UUGC_IGetActorsMethod, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_IGetActorsMethod), 2086687400U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Methods_UGC_IGetActorsMethod_h_404728248(TEXT("/Script/AuroraDevs_UGC"),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Methods_UGC_IGetActorsMethod_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Methods_UGC_IGetActorsMethod_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
