...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams;
class UScriptStruct* FUGCCameraAnimationParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUGCCameraAnimationParams, (UObject*)Z_Construct_UPackage__Script_AuroraDevs_UGC(), TEXT("UGCCameraAnimationParams"));
	}
	return Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.OuterSingleton;
}
template<> AURORADEVS_UGC_API UScriptStruct* StaticStruct<FUGCCameraAnimationParams>()
{
	return FUGCCameraAnimationParams::StaticStruct();
}
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FUGCCameraAnimationParams_Statics::NewProp_EaseInType = { "EaseInType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUGCCameraAnimationParams, EaseInType), Z_Construct_UEnum_GameplayCameras_ECameraAnimationEasingType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EaseInType_MetaData), NewProp_EaseInType_MetaData) }; // 235213627
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FUGCCameraAnimationParams_Statics::NewProp_EaseOutType = { "EaseOutType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FUGCCameraAnimationParams, EaseOutType), Z_Construct_UEnum_GameplayCameras_ECameraAnimationEasingType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EaseOutType_MetaData), NewProp_EaseOutType_MetaData) }; // 235213627
...
{
	if (!Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.InnerSingleton, Z_Construct_UScriptStruct_FUGCCameraAnimationParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams.InnerSingleton;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUGC_PlayCameraAnimCallbackProxy, nullptr, "CreateProxyObjectForPlayCameraAnim", nullptr, nullptr, Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::PropPointers), sizeof(Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::UGC_PlayCameraAnimCallbackProxy_eventCreateProxyObjectForPlayCameraAnim_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::Function_MetaDataParams), Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim_Statics::Function_MetaDataParams) };
...
DEFINE_FUNCTION(UUGC_PlayCameraAnimCallbackProxy::execCreateProxyObjectForPlayCameraAnim)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UUGC_PlayCameraAnimCallbackProxy**)Z_Param__Result=UUGC_PlayCameraAnimCallbackProxy::CreateProxyObjectForPlayCameraAnim(Z_Param_InPlayerCameraManager,Z_Param_ModifierClass,Z_Param_CameraSequence,Z_Param_Params,Z_Param_Out_Handle);
	P_NATIVE_END;
}
...
DEFINE_FUNCTION(UUGC_PlayCameraAnimCallbackProxy::execCreateProxyObjectForPlayCameraAnimForModifier)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UUGC_PlayCameraAnimCallbackProxy**)Z_Param__Result=UUGC_PlayCameraAnimCallbackProxy::CreateProxyObjectForPlayCameraAnimForModifier(Z_Param_CameraAnimationModifier,Z_Param_CameraSequence,Z_Param_Params,Z_Param_Out_Handle);
	P_NATIVE_END;
}
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UUGC_PlayCameraAnimCallbackProxy);
UClass* Z_Construct_UClass_UUGC_PlayCameraAnimCallbackProxy_NoRegister()
{
	return UUGC_PlayCameraAnimCallbackProxy::StaticClass();
}
struct Z_Construct_UClass_UUGC_PlayCameraAnimCallbackProxy_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnim, "CreateProxyObjectForPlayCameraAnim" }, // 3972189224
		{ &Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_CreateProxyObjectForPlayCameraAnimForModifier, "CreateProxyObjectForPlayCameraAnimForModifier" }, // 1550747851
		{ &Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_OnCameraAnimationEasingOut, "OnCameraAnimationEasingOut" }, // 3896378685
		{ &Z_Construct_UFunction_UUGC_PlayCameraAnimCallbackProxy_OnCameraAnimationEnded, "OnCameraAnimationEnded" }, // 976499374
	};
...
template<> AURORADEVS_UGC_API UClass* StaticClass<UUGC_PlayCameraAnimCallbackProxy>()
{
	return UUGC_PlayCameraAnimCallbackProxy::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FUGCCameraAnimationParams::StaticStruct, Z_Construct_UScriptStruct_FUGCCameraAnimationParams_Statics::NewStructOps, TEXT("UGCCameraAnimationParams"), &Z_Registration_Info_UScriptStruct_UGCCameraAnimationParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUGCCameraAnimationParams), 1604366366U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUGC_PlayCameraAnimCallbackProxy, UUGC_PlayCameraAnimCallbackProxy::StaticClass, TEXT("UUGC_PlayCameraAnimCallbackProxy"), &Z_Registration_Info_UClass_UUGC_PlayCameraAnimCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUGC_PlayCameraAnimCallbackProxy), 2882817284U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_1558672391(TEXT("/Script/AuroraDevs_UGC"),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_AuroraDevs_UGC_Source_AuroraDevs_UGC_Public_Camera_Modifiers_UGC_PlayCameraAnimCallbackProxy_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
